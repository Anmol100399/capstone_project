...
export default function LoginPage() {
  ...
  async function loginUser(ev) {
    ...
    console.log("Login button clicked"); // Log to verify the function is called
    ...
    try {
      ...
      console.error("Login error:", e); // Log the full error object
      alert("Login failed: " + (e.response?.data?.error || "An error occurred"));
    }
  }
  ...
  return (
    <div className ="flex w-full h-full lg:ml-24 px-10 py-10 justify-between place-items-center mt-20">
      <div className= "bg-white w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-3 rounded-xl justify-center align-middle">
    
        <form className="flex flex-col w-auto items-center" onSubmit={loginUser}>
          <h1 className='px-3 font-extrabold mb-5 text-primarydark text-2xl '>Log In</h1>
          <div className= "input">
